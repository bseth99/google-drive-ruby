...
require "google_drive_v3/api_client_fetcher"
require "google_drive_v3/client_login_fetcher"
require "google_drive_v3/oauth1_fetcher"
require "google_drive_v3/oauth2_fetcher"
require "google_drive_v3/error"
require "google_drive_v3/authentication_error"
require "google_drive_v3/spreadsheet"
require "google_drive_v3/worksheet"
require "google_drive_v3/collection"
    ...
    class Session
        ...
        def spreadsheet_by_key(key)
          ...
          if !file.is_a?(Spreadsheet)
            raise(GoogleDriveV3::Error, "The file with the ID is not a spreadsheet: %s" % key)
          end
          return file
        end
        ...
        def spreadsheet_by_url(url)
          ...
          if !file.is_a?(Spreadsheet)
            raise(GoogleDriveV3::Error, "The file with the URL is not a spreadsheet: %s" % url)
          end
          return file
        end
        ...
        def url_to_id(url)
          ...
          raise(GoogleDriveV3::Error, "The given URL is not a known Google Drive URL: %s" % url)
        end
        ...
        def collection_by_url(url)
          ...
          if !file.is_a?(Collection)
            raise(GoogleDriveV3::Error, "The file with the URL is not a collection: %s" % url)
          end
          return file
        end
        ...
        def request(method, url, params = {}) #:nodoc:
          ...
          while true
            ...
            if !(response.code =~ /^[23]/)
              raise(
                response.code == "401" ? AuthenticationError : GoogleDriveV3::Error,
